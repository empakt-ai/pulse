// ═════════════════════════════════════════════════════════════════════════
// [Mashal-SPECIFIC] HTML template for the executive report PDF. Pure server
...
<head>
<meta charset="UTF-8">
<title>Mashal Report · ${esc(workspace.name)} · ${esc(date)}</title>
<style>
...
<body>
  <header>
    <div class="logo">Mashal<span class="dot">.</span></div>
    <div class="meta">
  ...
  <footer>
    <span>Generated by Mashal · mashal.app</span>
    <span>© ${new Date().getFullYear()} Empakt Financial Inc.</span>
  </footer>
</body>
</html>`;
}
