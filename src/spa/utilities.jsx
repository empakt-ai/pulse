...
const PlatformIcons = () => (
  <svg width="0" height="0" style={{ position: 'absolute' }} aria-hidden="true">
    ...
    <symbol id="ic-tg" viewBox="0 0 24 24">
      ...
      <path d="M5.6 11.8l11.3-4.36c.53-.2.99.13.82.93l-1.93 9.08c-.13.6-.49.74-.99.46l-2.73-2.01-1.32 1.27c-.15.15-.27.27-.55.27l.2-2.8 5.1-4.6c.22-.2-.05-.31-.34-.12l-6.3 3.96-2.71-.85c-.59-.18-.6-.59.13-.88z" fill="white" />
    </symbol>
    <symbol id="ic-wa" viewBox="0 0 24 24">
      <rect width="24" height="24" rx="5" fill="#25D366" />
      <path fill="white" d="M12 6.2c-3.2 0-5.8 2.6-5.8 5.8 0 1 .27 1.98.78 2.84L6 18l3.26-.85c.83.45 1.77.69 2.74.69 3.2 0 5.8-2.6 5.8-5.8s-2.6-5.84-5.8-5.84zm0 10.6c-.86 0-1.7-.23-2.43-.67l-.17-.1-1.8.47.48-1.76-.11-.18a4.8 4.8 0 0 1-.74-2.56 4.8 4.8 0 0 1 8.2-3.4 4.74 4.74 0 0 1 1.4 3.4c0 2.65-2.16 4.8-4.83 4.8zm2.65-3.6c-.14-.07-.86-.42-.99-.47-.13-.05-.23-.07-.33.07-.1.14-.38.47-.46.57-.08.1-.17.11-.31.04-.86-.43-1.42-.77-1.99-1.74-.15-.26.15-.24.43-.8.05-.1.02-.18-.01-.25-.04-.07-.33-.79-.45-1.08-.12-.29-.24-.25-.33-.25l-.28-.01c-.1 0-.25.04-.39.18-.13.14-.51.5-.51 1.22s.53 1.42.6 1.51c.07.1 1.03 1.58 2.5 2.21.35.15.62.24.83.31.35.11.67.1.92.06.28-.04.86-.35.98-.69.12-.34.12-.63.09-.69-.04-.06-.13-.1-.27-.17z" />
    </symbol>
  </svg>
);
